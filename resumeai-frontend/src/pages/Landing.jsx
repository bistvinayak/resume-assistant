...
const s = {
  ...
  pillText: { fontSize: '12px', color: '#78716c', fontFamily: "'DM Mono', monospace" },
  h1: {
  ...
  sub: { fontSize: '17px', color: '#78716c', maxWidth: '460px', lineHeight: 1.65, marginBottom: '48px', fontWeight: 300 },
  btnGoogle: {
